...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : SPI_CAN_2_EXIT_Pin */
  GPIO_InitStruct.Pin = SPI_CAN_2_EXIT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(SPI_CAN_2_EXIT_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : SPI_CAN_2_CS_Pin */
  GPIO_InitStruct.Pin = SPI_CAN_2_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(SPI_CAN_2_CS_GPIO_Port, &GPIO_InitStruct);
